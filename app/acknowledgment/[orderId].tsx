...
export default function AcknowledgmentScreen() {
  ...
  const handleMarkReceived = async () => {
    ...
    try {
      ...
      if (updated) {
        Alert.alert(
          "Thank you!",
          "Delivery marked as received. Enjoy your meal!",
  ...
  const canAck =
    order?.status === "waiting_for_ack" || order?.status === "out_for_delivery";
        ...
        {loading ? (
          ...
          <View style={styles.center}>
            ...
            <Text style={styles.subtitle}>
              We couldn't find the order associated with this notification.
            </Text>
          </View>
        ) : (
          <View style={styles.content}>
            ...
            {!canAck && (
              <Text style={styles.helper}>
                You can only acknowledge orders that are waiting for
                confirmation.
              </Text>
            )}
          </View>
